...
export const CHANNEL_MAP = {
  ...
  5:  { name: 'left_shoulder_pitch_joint',  group: 'left_arm',  label: 'Shoulder Pitch',  center: 158, sign:  1.0, radPerPwm: (Math.PI / 135), lower: -3.1416, upper: 1.5708 },
  6:  { name: 'left_shoulder_roll_joint',   group: 'left_arm',  label: 'Shoulder Roll',   center: 243, sign: -1.0, radPerPwm: (Math.PI / 135), lower: -0.0873, upper: 2.9671 },
  ...
  9:  { name: 'right_shoulder_roll_joint',  group: 'right_arm', label: 'Shoulder Roll',   center:  75, sign: -1.0, radPerPwm: (Math.PI / 135), lower: -2.9671, upper: 0.0873 },
  10: { name: 'right_shoulder_pitch_joint', group: 'right_arm', label: 'Shoulder Pitch',  center: 156, sign: -1.0, radPerPwm: (Math.PI / 135), lower: -1.5708, upper: 2.0071 },
